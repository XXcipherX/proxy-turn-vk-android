...
Если при установке выбраны нестандартные порты, укажите их в ручных настройках подключения Android-клиента.
...
Команда `/list` показывает активные пароли, а также все устройства главного пароля. Через inline-кнопки можно удалить главное устройство, отвязать устройство сгенерированного пароля или удалить сам пароль. При удалении или истечении пароля соответствующий WRAP-ключ удаляется из памяти сервера.
